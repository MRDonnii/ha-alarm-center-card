  ...
  _render() {
    ...
    this.shadowRoot.innerHTML = `<style>
      ...
      *{box-sizing:border-box}
      ...
      @media(max-width:480px){.row-text .entity-id{display:none}.snooze-btn span{display:none}}
    </style>
    <ha-card>
      <div class="head">
